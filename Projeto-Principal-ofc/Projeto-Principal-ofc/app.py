...
@app.route("/estoque_do_galpao")
def estoque_do_galpao():
    return "<h1>Estoque do galpão (em construção)</h1>"

@app.route("/info_galpao")
def info_galpao():
    return "<h1>Informações do galpão (em construção)</h1>"
