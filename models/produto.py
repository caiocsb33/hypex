...
class Produto(CrudBase):
            ...
            cursor.execute(
                ...
                INSERT INTO produto
                    (sku, nome, descricao, categoria, preco_custo,
                     preco_venda, peso, volume, tipo, codigo_barras)
    ...
    # CORREÇÃO: find_all_completo agora está dentro da classe
    # Traz produto + quantidade/estoque_minimo do estoque + nome do fornecedor
    @classmethod
            ...
            if galpao_id:
                cursor.execute("""
                    SELECT
                        ...
                        COALESCE(e.estoque_minimo, 0)  AS quantidade_minimo,
