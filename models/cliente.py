...
class Cliente:
    ...
    def __init__(self, nome, empresa, cidade, estado,
    ...
    def insert(self):
        ...
        try:
            cursor.execute("""
                INSERT INTO cliente
                (nome, empresa, cidade, estado, cpf_cnpj, cep, email, telefone)
                VALUES (%s, %s, %s, %s, %s, %s, %s, %s)
            """, (
                self.nome, self.empresa, self.cidade, self.estado,
